	...
	<div class="container-fluid body-container">
		<div class="row body-box">
			...
			<div class="col-md-10 main-container">
				...
				<div class="container">
					<h1>
						<fmt:message key="users.index.title"></fmt:message>
					</h1>
					<table id="table" data-toggle="table" data-filter-control="true"
						...
						<thead>
							<tr class="text-center">
								...
								<th><a href="users/new" class="btn btn-primary btn-block"><fmt:message
											key="btn.add"></fmt:message></a></th>
							</tr>
						</thead>
						<tbody>
								...
								<c:forEach items="${ requestScope.users }" var="user"
									...
									<tr>
										...
										<td><a href="users/${user.id }/edit"
											...
											<a href="users/${user.id}" class="delete btn btn-danger"><fmt:message
